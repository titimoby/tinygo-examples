Examples for [Adafruit Clue](https://www.adafruit.com/product/4500)
...
- 03-Bluetooth-scanner: example from [tinygo-org/bluetooth](https://github.com/tinygo-org/bluetooth/blob/release/examples/clue-scanner/main.go)