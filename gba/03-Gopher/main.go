...
func drawGophers() {
	...
	tinyfont.DrawChar(display, &freemono.Bold24pt7b, 36, 60, 'G', gBlue)
	tinyfont.DrawChar(display, &freemono.Bold24pt7b, 71, 60, 'o', gRed)
	tinyfont.DrawChar(display, &freemono.Bold24pt7b, 98, 60, 'p', gYellow)
	tinyfont.DrawChar(display, &freemono.Bold24pt7b, 126, 60, 'h', gGreen)
	tinyfont.DrawChar(display, &freemono.Bold24pt7b, 154, 60, 'e', gBlue)
	tinyfont.DrawChar(display, &freemono.Bold24pt7b, 180, 60, 'r', gRed)
